      ...
      <div class="content-modal-wrapper">
        ...
        <div class="modal-select-container">
          ...
          <div class="modal-select-item">
            ...
            <select class="modal-select select" v-model="compTooth2.typeConstruction">
          ...
          <div class="modal-select-item">
            ...
            <select class="modal-select" v-model="compTooth2.typeConstruction">
              <option class="option-modal default-option" selected :value="'-'">Выберите значение</option>
      ...
      <div class="content-modal-wrapper">
        ...
        <div class="modal-select-container" id="implants">
          ...
          <div class="modal-select-item">
            ...
            <select class="modal-select" v-model="compTooth2.implantSystem">
      ...
      <div class="content-modal-wrapper">
        ...
        <div class="modal-select-container">
          ...
          <div class="modal-select-item">
            ...
            <select class="modal-select" v-model="compTooth2.material">
