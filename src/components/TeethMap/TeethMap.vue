            ...
            <div id="flag-container">
              ...
              <div id="flag-content1">
                ...
                <ul>
                  ...
                  <li class="flag-li">Карта зубов схематически будет увеличивать протяженность соединительными линиями при выборе <br>чек-боксов на соседних зубах.</li>
                </ul>
              </div>
          ...
          <div id="flag-container">
            ...
            <div id="flag-content2">
              ...
              <ul>
                ...
                <li class="flag-li">После чего вы окажетесь на схеме, где можно выбрать определенный этап. <br> (предусмотрено два этапа изготовления)</li>
                <li class="flag-li">Далее меню наряда предоставит вам возможность выбрать в хаотичном порядке <br> нужные параметры, предусматривающие данную конструкцию.</li>
                <li class="flag-li">Во избежание повторяющихся манипуляций, предусмотрена возможность копирования параметров
                  <br> зуба на любой другой с идентичными характеристиками. <br> (правая кнопка мыши на заполненном зубе)</li>
                <li class="flag-li">После заполнения всех необходимых разделов, все данные будут выведены в таблицу,
                  <br> которая будет направлена в лабораторию и продублирована вам на электронную почту.</li>
              </ul>
      ...
      if (isActive === true) {
        ...
        let newCopyTooth = copyTooth.map(obj => {
          ...
          Object.entries(obj).forEach(([key, value]) => {
            if (key !== 'toothNumber') {
              newObj[key] = key === 'stage1' || key === 'stage2' ? { ...value } : value
            }
          })
          // console.log(newObj)
          return this.copyObj = newObj
        })

        // Создаем новый массив с экземплярами объектов без указанных свойств
        newCopyTooth = copyTooth.map(obj => ({
        ...
        this.lastToothNumber = this.toothNumber
      }
    },

    insertTooth () {
      this.$store.state.module1.chooseTeeth.push(this.copyObj);
      ...
      // copyTooth[0].toothId = `tooth${this.lastToothNumber}`
