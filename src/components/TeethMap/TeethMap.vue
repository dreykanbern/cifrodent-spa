          ...
          <div id="flag-container">
            ...
            <div id="flag-content2">
              ...
              <ul>
                ...
                <li class="flag-li">После заполнения всех необходимых разделов, все данные будут выведены в таблицу, которая будет<br> направлена в лабораторию и продублирована вам на электронную почту.</li>
              </ul>
